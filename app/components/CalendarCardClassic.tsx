...
<<<<<<< HEAD
        ...
        {/* Header */}
        <div className="text-center bg-white border-b-2 p-4"
          style={{ borderColor: 'rgba(255, 140, 0, 0.3)', background: 'linear-gradient(135deg, rgba(238, 177, 133, 0.27) 0%, rgba(225, 155, 75, 0.05) 100%)' }}>
...
<<<<<<< HEAD
              ...
              <div className="border-2 border-t-0 overflow-x-auto" style={{ borderColor: 'rgba(255, 140, 0, 0.3)' }}>
